...
<!--                <li> <a class="button border-main icon-plus-square-o" href="add.php"> 添加内容</a> </li>-->
        ...
        <table class="table table-hover text-center">
            ...
            <?php
            foreach ($arr_team as $row)
            {
                ?>
                <tr>
                    <td style="text-align:left; padding-left:20px;"><?php echo $row['id'] ?></td>
                    <td width="10%"><?php echo $row['display_flag'] ?></td>
                    <td><?php echo $row['content_topic']?></td>
                    <td><?php echo $row['key_tag']?></td>
                    <td><img src="<?php echo $row['pic'] ?>" alt="Oops No Picture" width="70" height="50" /></td>
                    <td><?php echo $row['commander_name']?></td>
                    <td><?php echo $row['created_time']?></td>
                    <td><div class="button-group"> <a class="button border-main" href="allow_team_display.php?id=<?php echo $row['id'];?>"><span class="icon-edit"></span> 允许</a> <a class="button border-red" href="del_team_display.php?id=<?php echo $row['id']?>&veri_code=<?php echo $row['veri_code'];?>" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>

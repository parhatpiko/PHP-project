...
<form method="post" action="" id="listform">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            <?php
            foreach ($arr_judge as $row)
            {
                ?>
                <tr>
                    <td style="text-align:left; padding-left:20px;"><?php echo $row['id'] ?></td>
                    <td width="10%"><?php echo $row['authen_flag'] ?></td>
                    <td><?php echo $row['username']?></td>
                    <td><?php echo $row['position']?></td>
                    <td><?php echo $row['cell']?></td>
                    <td><?php echo $row['created_time']?></td>
                    <td><div class="button-group"> <a class="button border-main" href="allow_judge.php?id=<?php echo $row['id'];?>"><span class="icon-edit"></span> 允许</a> <a class="button border-main" href="disallow_judge.php?id=<?php echo $row['id'];?>"><span class="icon-edit"></span> 待定</a><a class="button border-red" href="del_judge.php?id=<?php echo $row['id']?>" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
                </tr>
                <?php
            }
            ?>

    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-main icon-plus-square-o" href="sponsor_introduction_add.php"> 添加内容</a> </li>
        ...
        <table class="table table-hover text-center">
            ...
            <?php
            foreach ($arr_sponsor as $row)
            {
                ?>
                <tr>
                    <td style="text-align:left; padding-left:20px;"><?php echo $row['id'] ?></td>
                    <td><?php echo $row['sponsor_name']?></td>
                    <td><img src="<?php echo $row['sponsor_pic'] ?>" alt="Oops No Picture" width="70" height="50" /></td>
                    <td><?php echo $row['created_time']?></td>
                    <td><div class="button-group"> <a class="button border-main" href="sponsor_edit.php?id=<?php echo $row['id'];?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="sponsor_delete.php?id=<?php echo $row['id']?>" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
